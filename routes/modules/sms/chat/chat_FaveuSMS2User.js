...
function chat_FaveuSMS2User(favef, chatf) {
    var message = 'Your FaveU wants to caht with you. Please join the chat room with user: ' + favef.username + ', room: ' + chatf.room + '.';

    // console.log("inside SMS")
    client.messages.create({
        body: message,
        to: '+15103964657',  // Text this number
        // to: favef.userphone,  // Text this number
...
function subchat_UserSMS2Faveu(chat, mode) {
    ...
    var updateddata4chat = (mode === 'resolve') 
                ...
                : {$push: {processerror: "reverseChatSMS"}}
...
module.exports = {chat_FaveuSMS2User}