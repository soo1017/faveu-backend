...
function createEmailchat4Gmail(ses, from_email, faveu_email, faveu_name, roomname){

    var subject = "FaveU: Your FaveU wants to chat with you";
...
// '        padding-top:30px;' +
'      }' +
'      .imageContainer2 .cls-2p-2 {' +
'        padding-top:10px;' +
'      }' +
'      .imageContainer2 .cls-2p-3 {' +
'        padding-top:10px;' +
'      }' +
'      .imageContainer2 .cls-2p-4 {' +
'        padding-top:10px;' +
'      }' +
'      .imageContainer2 .cls-2p-5 {' +
'        padding-top:20px;' +
'      }' +
'      .imageContainer2 .cls-2p-6 {' +
'        padding-top:20px;' +
// '        padding-top:45px;' +
'      }' +
'      .imageContainer2 a {' +
...
'                      <h3>Hi ' + faveu_name + '</h3>' +
'                      <p class="cls-p1">Your FaveU wants to chat with you.</p>' +
'                      <p class="cls-p2">Please follow the steps to join the chat room.</p>' +
'                    </div>' +
'                  </td>' +
'                </tr>' +
'                <tr>' +
...
'                       <p class="cls-2p-1">1. Download "FaveU" mobile app.</p>' +
'                       <p class="cls-2p-2">2. Click the icon at the right-top for chat "join" page</p>' +
'                       <p class="cls-2p-3">3. Place the following info below</p>' +
'                       <p class="cls-2p-4">4. Click "join"</p>' +
'                       <p class="cls-2p-5">User: ' + faveu_name + '</p>'
'                       <p class="cls-2p-6">Room: ' + roomname + '</p>'
'                    </div>' +
'                  </td>' +
'                </tr>' +
'                <tr>' +
...
module.exports = {createEmailchat4Gmail};
