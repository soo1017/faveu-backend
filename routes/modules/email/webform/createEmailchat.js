...
function createEmailchat(ses, from_email, faveu_email, faveu_name, roomname){
...
'                       <p class="cls-2p-2">2. Click the icon at the right-top to come chat "join" page</p>' +
...
module.exports = {createEmailchat};